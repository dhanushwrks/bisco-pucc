...
import { saveBusinessSettings, saveReminderSettings } from "../actions";
...
export default async function Settings() {
  ...
  const [{ data: org }, { data: optedOut }] = await Promise.all([
  ...
  return (
    <>
      <PageHeader
        title="Settings"
        subtitle="Business profile and reminder rules for your centres."
      />
